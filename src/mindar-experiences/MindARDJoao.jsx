...
export default function MindARDJoao({ onTap }) {
  ...
  const handleClosePopUp = () => {
    setShowPopUp(false);
    setModelsVisible(true); // Models appear immediately when popup closes
  };
  ...
  useEffect(() => {
    ...
    const handleInteraction = (clientX, clientY) => {
      ...
      if (hitsJoia2.length > 0 && joia2Ref.current && !collectedRef.current.joia2) {
        ...
        collectedRef.current.joia2 = true; 
        reduceCounterOnTap();
      }
      if (hitsDiamantes21.length > 0 && diamantes21Ref.current && !collectedRef.current.diamantes21) {
        ...
        collectedRef.current.diamantes21 = true; 
        reduceCounterOnTap();
      }
      if (hitsDiamantes2.length > 0 && diamantes2Ref.current && !collectedRef.current.diamantes2) {
        ...
        collectedRef.current.diamantes2 = true; 
        reduceCounterOnTap();
      }
      if (hitsMoedas1.length > 0 && moedas1Ref.current && !collectedRef.current.moedas1) {
        ...
        collectedRef.current.moedas1 = true; 
        reduceCounterOnTap();
      }
  ...
  const handleRestart = () => {
    ...
    resetEntity(joia1Ref, '0.2 0.8 0.01');
    resetEntity(joia2Ref, '0.3 1 0.01');
    resetEntity(diamantes21Ref, '0.7 0 0.01');
    resetEntity(diamantes2Ref, '-0.4 0.8 0.01'); 
    resetEntity(moedas1Ref, '-0.6 0 0.01');
    resetEntity(moedas2Ref, '0.7 -0.2 0.01');
    resetEntity(azeiteRef, '0 -0.3 0.01');
    resetEntity(copoRef, '-0.8 0 0.01');
  };
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div className="counter-div">
        <p className="counter-text">Toque nos itens.</p>
        <p className="counter-text">Riqueza em falta: {counter}</p>
      </div>
