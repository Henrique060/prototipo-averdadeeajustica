    ...
    <>
      ...
      <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
          ...
          <div className="header-container-mindar">
            ...
            {showPopUp && (
              <LearnMorePopUp
                ...
                description="Aponte a câmara aos azulejos demonstrados acima, de modo a observar uma experiência audiovisual."
              />
            )}
          </div>
        )}
        ...
        {buttonVisible && !isVideoPlaying && (
          ...
          >
            {hasWatched ? "Ver novamente" : "Veja o terramoto"}
          </button>
        )}
        ...
        <a-scene
          ref={sceneRef}
          mindar-image="imageTargetSrc: /markers/terramoto-marker.mind; filterMinCF: 0.1; filterBeta: 10; missTolerance: 4; warmupTolerance: 1; autoStart: false; uiLoading: no; uiError: no; uiScanning: no;"
          color-space="sRGB"
          embedded
