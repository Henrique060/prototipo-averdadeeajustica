...
export default function MindARLenco({ videoSrc = "/videos/oretorno.mp4" }) {
    ...
    <>
      ...
      <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
          ...
          <div className="header-container-mindar">
            ...
            {showPopUp && (
              <LearnMorePopUp
                ...
                description="Com a câmara, procure pelo quadro representado acima. Aponte para experienciar uma interpretação visual do mesmo."
              />
            )}
          </div>
        )}
        ...
        {buttonVisible && !isVideoPlaying && (
          ...
          >
            {hasWatched ? "Ver novamente" : "Veja o caminho para a justiça"}
          </button>
        )}
        ...
        >
          ...
          <a-assets>
            <img id="oretorno" src="/images/oretorno.webp" />
          </a-assets>

          <a-camera position="0 0 0" look-controls="enabled: false"></a-camera>
          
          <a-entity mindar-image-target="targetIndex:0">
            <a-image src="#oretorno" position="0 0.25 0" height="2" width="1" material="transparent: true"></a-image>
          </a-entity>
        </a-scene>
      </div>
    </>
